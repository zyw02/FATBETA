...
# If you need to override them, edit configs/search/search_alexnet_cifar10_single_gpu.yaml directly
python main.py configs/search/search_alexnet_cifar10_single_gpu.yaml
