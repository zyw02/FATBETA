...
def create_optimizer_and_lr_scheduler(model, configs):
    ...
    if quantizer_optim == 'adam':
        ...
        # 2025/5/27: 原代码中使用timm的scheduler，现在
...
def update_meter(meter, loss, QE_loss, dist_loss, IDM_loss, acc1, acc5, size, batch_time, world_size=None):
