...
def train(
    ...
    for batch_idx, (inputs, targets) in enumerate(train_loader):
        ...
        if not (use_bfat and proj_mode == "none"):
            ...
            # BFAT Logic
            # NEW: 增加一个开关项，模拟 Normal 组的梯度累积效果
            ...
            if use_bfat and fault_injector is not None:
                ...
                if accumulate_grad_mode:
                    ...
                    for _ in range(3):
                        current_seed = getattr(fault_injector, 'seed', None)
                        if current_seed is None:
                            fault_injector.seed = 1
                        else:
                            fault_injector.seed = int(current_seed) + 1
