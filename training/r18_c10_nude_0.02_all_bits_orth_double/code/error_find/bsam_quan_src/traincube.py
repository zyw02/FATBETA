import sys
import os
# python "/root/autodl-tmp/cube/quansam/bsam_quan_src/traincube.py" configs/training/wu_train_alexnet_w26a26.yaml
# 检查当前操作系统是否为Linux
...
from ctl_factory import train_cubesam_epoch
    ...
    if configs.eval:
        ...
        if 1:
            ...
            for epoch in range(start_epoch, configs.epochs):
                ...
                train_cubesam_epoch(model, train_loader, test_loader, criterion, optimizer, epoch, configs,
                                          lr_scheduler=lr_scheduler, optimizer_q=optimizer_q, annealing_schedule=annealing_schedule,
                                          freezing_annealing_schedule=freezing_annealing_schedule,rho=3.0)
                ...
                if (epoch + 1) % 20 == 0 and epoch > 179:
                    torch.save(model.state_dict(), f'../trained_models/alexnet_cubesam_timm_w6a6_{epoch}_0.0015.pt')
